export function getCommandHelpText() {
  return [
    ...
    "`/samurai path` - show your stored samurai storyline progress",
    "`/samurai train action:bossing` - gain samurai path XP",
    "`/samurai board` - show the samurai path leaderboard",
